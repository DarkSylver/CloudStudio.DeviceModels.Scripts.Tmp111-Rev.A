...
# Configuration Script – Tmp111 - Rev. A

This **Configuration** script is designed for the **Tmp111** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Tmp111 Rev. A

Este script de **Configuration** está diseñado para el modelo **Tmp111** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
